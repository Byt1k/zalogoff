...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <link rel="stylesheet" href="wp-content/themes/rebottle/assets/css/main.css">
</head>
<body>
	...
	<div class="row">
		<div class="col-12 text-center">
			<div class="call-success">
				...
				<h3 class="mt-5">Данные успешно отправлены!</h3>
				<p class="px-4 mt-4">Наш специалист свяжется с Вами через несколько минут</p>
			</div>
		</div>
	</div>
</div>
